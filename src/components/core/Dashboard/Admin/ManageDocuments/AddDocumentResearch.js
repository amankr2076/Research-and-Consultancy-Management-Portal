...
import { AddDocumentInExistingResearchProject } from '../../../../../services/operations/Admin/AddSettings';
import { useSelector } from 'react-redux';
import toast from 'react-hot-toast';

const AddDocumentResearch = () => {
    ...
    const [formdata, setFormdata] = useState({
      ...
      const finalSubmit= async ()=>{
        ...
        AddDocumentInExistingResearchProject(token,formDataFinal);
  ...
  return (
    <div className='flex flex-col gap-y-4 px-12 py-8 w-[900px] mx-auto overflow-hidden bg-white shadow-xl sm:rounded-lg'>
        <form onSubmit={handleOnSubmit}>
            <h2 className='font-semibold'>Want to add more documents to Research Project</h2>
...
export default AddDocumentResearch