...
import { addConsultanctyInvoices} from '../../../../../services/operations/Admin/AddSettings';
...
const AddInvoice = () => {
    ...
    const [share,setShare]=useState({net_amount:"",gst_amount:""});
    ...
    const [formData, setFormData] = useState({
      ...
      const { project_id, fund, date} = formData;
      ...
      const handleOnChange = (e) => {
        ...
        if(e.target.name==="fund")
          {
              let net_amount=e.target.value/(1.18);
              let gst_amount=(e.target.value-net_amount);
              setShare({net_amount,gst_amount});
          }
      }
      ...
      const handleOnSubmit = (e) => {
        ...
        if(date.trim() === "" || fund.trim()==="" || project_id.trim()==="")
        {
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                      ...
                      (
                        ...
                        {fund && <div className="sm:col-span-3 mt-6">
                          <div className="block text-sm font-medium leading-6 text-gray-900">
                            Net amount : {share.net_amount}
                            <br></br>
                            GST amount : {share.gst_amount}
                          </div>
                        </div>}
        ...
        <Dialog open={confirmation} onClose={() => {}} className="relative z-10">
            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                ...
                >
                    ...
                    <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-2">
                            <p className="text-sm text-gray-500">
                                Are You Sure
                            <br></br>
                                Invoivce will be raised for the selected project
                            </p>
                        </div>
                        </div>
                    </div>
                    ...
                    <button
                        type="button"
                        onClick={() => {setConfirmation(false); addConsultanctyInvoices(token,formData); setFormData({project_id: "",fund: "",date: ""})}}
