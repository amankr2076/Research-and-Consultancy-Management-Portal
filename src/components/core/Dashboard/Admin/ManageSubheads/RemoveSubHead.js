...
import { removeSubHead } from '../../../../../services/operations/Admin/ModifySetting';
  ...
  return (
    <div className='mt-10'>
        <form onSubmit={handleOnSubmit}>
            <h2>Select the sub-Head to be removed</h2>
            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                ...
                >
                    ...
                    <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-2">
                            <p className="text-sm text-gray-500">
                                Are You Sure
                            <br></br>
                                Selected Sub head will be removed
                            </p>
                        </div>
                        </div>
                    </div>
                    ...
                    <button
                        type="button"
                        onClick={() => {setConfirmation(false); removeSubHead(token,formData);  setFormData({subHead_id: ""})}}
