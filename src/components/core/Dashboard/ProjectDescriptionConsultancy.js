...
import FundDetailsConsultancy from './FundDetailsConsultancy';
...
export default function ProjectDescriptionConsultancy() {
  ...
  return (
    ...
    {fund_details.length>0 ? (<FundDetailsConsultancy fund_details={fund_details} setIsChoosen={setIsChoosen} type={type}></FundDetailsConsultancy>) : 
