...
import FundDetailsResearch from './FundDetailsResearch';
...
export default function ProjectDescriptionResearch() {
  ...
  return (
    ...
    {fund_details.length>0 ? (<FundDetailsResearch fund_details={fund_details} setIsChoosen={setIsChoosen} type={type}></FundDetailsResearch>) : 
